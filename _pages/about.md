---
permalink: /
title: "Cheng Chen: Embodied Agents & Reinforcement Learning"
author_profile: true
redirect_from: 
  - /about/
  - /about.html
...
<div style="display: flex; gap: 20px; margin-top: 20px;">
  <div style="flex: 1 1 50%;">
    ...
    <div style="background-color:#eee;border-radius:5px;">
      <div style="width:12%;background-color:#007bff;color:white;text-align:right;padding-right:10px;border-radius:5px;height:30px;line-height:30px;">
      </div>
    </div>
  </div>
  <div style="flex: 1 1 50%;">
